...
?>
    ...
    <div class="my-team-content-main clearfix">
            ...
            <!--<div class="col-md-3">
                <div class="my-team-content-player">

                    <?php /*if (isset($player->is_user) == 0 ) : */?>
                        <div class="not-confirmed-player">
                            <p><?/*= $player->username; */?></p>
                        </div>
                    <?php /*else: */?>
                        <div class="my-team-content-player-top">
                            <?/*= Html::img('/images/' . $team_data->title . '/players/' . $player->player_name  . '.png', ['class' => 'my-team-content-player-image']); */?>
                        </div>
                        <div class="my-team-content-player-bottom">
                            <div class="my-team-player-name">
                            ...
                            <div class="my-team-player-date">
                                <span>Age</span>
                                <span class="player-date">
                                <?php
/*                                    $birth_year = Yii::$app->formatter->asDate($player->player_date, 'Y');
                                    echo date('Y') - $birth_year;
                                */?>
                            </span>
                            </div>
                            <div class="my-team-player-level">
                                <span>Level</span>
                                <span class="level-count">1</span>
                            </div>
                            <div class="my-team-player-goals">
                                <span>Goals</span>
                                <span class="goals-count">0</span>
                            </div>
                            <div class="my-team-player-passes">
                                <span>Passes</span>
                                <span class="passes-count">0</span>
                            </div>
                        </div>
                    <?php /*endif; */?>
